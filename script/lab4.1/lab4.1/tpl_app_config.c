...
CONST(tpl_appmode_mask, OS_CONST) tpl_alarm_app_mode[ALARM_COUNT] = {
  1 /* alarm a100sec : stdAppmode | stdAppmode */ ,
  1 /* alarm a125msec : stdAppmode | stdAppmode */ ,
  1 /* alarm a500msec : stdAppmode | stdAppmode */ 
};
...
/* Alarm a100sec identifier */
#define a100sec_id 0
CONST(AlarmType, AUTOMATIC) a100sec = a100sec_id;
...
CONST(tpl_task_activation_action, OS_CONST) a100sec_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) a100sec_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , a100sec_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&a100sec_action
};
...
VAR(tpl_time_obj, OS_VAR) a100sec_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&a100sec_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  98,
    /* date                         */  98,
