...
#--- automatically generated by goil on Tue Dec 19 11:50:45 2023
#--- from root OIL file lab4.1.oil
#---
...
#--- OIL file
oilSourceList.append("lab4.1.oil")
...
cSourceList.append(projfile.ProjectFile("lab4.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab4.1/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab4.1/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("lab4.1/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("lab4.1/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab4.hex from lab4")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab4")
  postCommand.mCommand.append("lab4.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab4 on avr/arduino/uno\033[0m")
