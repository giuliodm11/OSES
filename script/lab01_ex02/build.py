...
#--- automatically generated by goil on Wed Oct 16 16:55:42 2024
...
sys.path.append("/Users/giuliodimartino/Desktop/trampoline/make")
...
includeDirs += ["-I","/Users/giuliodimartino/Desktop/trampoline/machines/avr/arduino/cores/arduino"]
includeDirs += ["-I","/Users/giuliodimartino/Desktop/trampoline/machines/avr/arduino/"]
includeDirs += ["-I","/Users/giuliodimartino/Desktop/trampoline/machines/avr/arduino/variants/standard"]
includeDirs += ["-I","/Users/giuliodimartino/Desktop/trampoline/machines/avr"]
includeDirs += ["-I","/Users/giuliodimartino/Desktop/trampoline/machines/avr/arduino/cores/arduino"]
includeDirs += ["-I","/Users/giuliodimartino/Desktop/trampoline/machines/avr/arduino/cores/arduino"]
if with_ioc:
  includeDirs += ["-I", "/Users/giuliodimartino/Desktop/trampoline/ioc"]
includeDirs += ["-I", "/Users/giuliodimartino/Desktop/trampoline/com"]
includeDirs += ["-I", "/Users/giuliodimartino/Desktop/trampoline/os"]
includeDirs += ["-I", "/Users/giuliodimartino/Desktop/trampoline/debug"]
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab01.hex from lab01")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab01")
  postCommand.mCommand.append("lab01.hex")
...
postVariableMapping = dict(
  MACHINE_PATH='/Users/giuliodimartino/Desktop/trampoline/machines',
  ARCH_PATH='/Users/giuliodimartino/Desktop/trampoline/machines/avr',
  BOARD_PATH='/Users/giuliodimartino/Desktop/trampoline/machines/avr/arduino/uno',
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab01 on avr/arduino/uno\033[0m")
