 ...
 * Automatically generated by goil on Wed Dec 20 11:04:58 2023
 * from root OIL file lab4.3.oil
 *
...
/* Task TaskZ identifier */
#define TaskZ_id 0
CONST(TaskType, AUTOMATIC) TaskZ = TaskZ_id;

/*=============================================================================
 * Declaration of Alarm IDs
 */

/* Alarm a25ms identifier */
#define a25ms_id 0
CONST(AlarmType, AUTOMATIC) a25ms = a25ms_id;
 ...
 */
/*-----------------------------------------------------------------------------
 * Task TaskZ descriptor
 */
#define APP_Task_TaskZ_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task TaskZ function prototype
 */

FUNC(void, OS_APPL_CODE) TaskZ_function(void);
#define APP_Task_TaskZ_STOP_SEC_CODE
 ...
 *
 */
#define APP_Task_TaskZ_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word TaskZ_stack_zone[128/sizeof(tpl_stack_word)];
#define APP_Task_TaskZ_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define TaskZ_STACK { TaskZ_stack_zone, 128 }

/*
 * Task TaskZ context
 */
avr_context TaskZ_int_context;
#define TaskZ_CONTEXT &TaskZ_int_context
...
/*
 * Resources used by task TaskZ
 *
 * Sem
 */

/*
 * Static descriptor of task TaskZ
 */
CONST(tpl_proc_static, OS_CONST) TaskZ_task_stat_desc = {
  /* context                  */  TaskZ_CONTEXT,
  /* stack                    */  TaskZ_STACK,
  /* entry point (function)   */  TaskZ_function,
  /* internal ressource       */  NULL,
  /* task id                  */  TaskZ_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task TaskZ
 */
VAR(tpl_proc, OS_VAR) TaskZ_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
 ...
 */
/*-----------------------------------------------------------------------------
 * Alarm a25ms descriptor
 *
 * This alarm does the activation of task TaskZ
 */
...
CONST(tpl_task_activation_action, OS_CONST) a25ms_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) a25ms_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , a25ms_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&a25ms_action
};
...
VAR(tpl_time_obj, OS_VAR) a25ms_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&a25ms_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  24,
    /* date                         */  24,
