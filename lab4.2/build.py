...
#--- OIL file
oilSourceList.append("lab4.2.oil")
...
cSourceList.append(projfile.ProjectFile("lab4.2.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab4.2/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab4.2/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("lab4.2/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("lab4.2/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab4_2.hex from lab4_2")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab4_2")
  postCommand.mCommand.append("lab4_2.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab4_2 on avr/arduino/uno\033[0m")
