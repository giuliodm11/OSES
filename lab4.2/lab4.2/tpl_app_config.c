 ...
 * Automatically generated by goil on Mon Dec 18 09:31:57 2023
 * from root OIL file lab4.2.oil
 *
...
CONST(tpl_appmode_mask, OS_CONST) tpl_alarm_app_mode[ALARM_COUNT] = {
  1 /* alarm a100ms : stdAppmode */ ,
  1 /* alarm a125ms : stdAppmode */ 
};
...
/* Alarm a100ms identifier */
#define a100ms_id 0
CONST(AlarmType, AUTOMATIC) a100ms = a100ms_id;

/* Alarm a125ms identifier */
#define a125ms_id 1
CONST(AlarmType, AUTOMATIC) a125ms = a125ms_id;
...
CONST(tpl_task_activation_action, OS_CONST) a100ms_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) a100ms_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , a100ms_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&a100ms_action
};
...
VAR(tpl_time_obj, OS_VAR) a100ms_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&a100ms_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  98,
    /* date                         */  98,
...
CONST(tpl_task_activation_action, OS_CONST) a125ms_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskV_id
...
CONST(tpl_alarm_static, OS_CONST) a125ms_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , a125ms_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&a125ms_action
};
...
VAR(tpl_time_obj, OS_VAR) a125ms_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&a125ms_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  122,
    /* date                         */  122,
