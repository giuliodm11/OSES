...
#--- OIL file
oilSourceList.append("lab5.1.oil")
...
cSourceList.append(projfile.ProjectFile("lab5.1.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab5.1/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab5.1/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("lab5.1/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("lab5.1/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab51.hex from lab51")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab51")
  postCommand.mCommand.append("lab51.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab51 on avr/arduino/uno\033[0m")
