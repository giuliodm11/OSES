 ...
 * Automatically generated by goil on Thu Jan 18 09:19:12 2024
 * from root OIL file lab5.1.oil
 *
...
CONST(tpl_appmode_mask, OS_CONST) tpl_alarm_app_mode[ALARM_COUNT] = {
  1 /* alarm a1000ms : stdAppmode */ ,
  1 /* alarm a20ms : stdAppmode */ 
};
...
/* Task TaskD identifier */
#define TaskD_id 0
CONST(TaskType, AUTOMATIC) TaskD = TaskD_id;
...
/* Alarm a1000ms identifier */
#define a1000ms_id 0
CONST(AlarmType, AUTOMATIC) a1000ms = a1000ms_id;

/* Alarm a20ms identifier */
#define a20ms_id 1
CONST(AlarmType, AUTOMATIC) a20ms = a20ms_id;
 ...
 */
/*-----------------------------------------------------------------------------
 * Task TaskD descriptor
 */
#define APP_Task_TaskD_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task TaskD function prototype
 */

FUNC(void, OS_APPL_CODE) TaskD_function(void);
#define APP_Task_TaskD_STOP_SEC_CODE
 ...
 *
 */
#define APP_Task_TaskD_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word TaskD_stack_zone[128/sizeof(tpl_stack_word)];
#define APP_Task_TaskD_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define TaskD_STACK { TaskD_stack_zone, 128 }

/*
 * Task TaskD context
 */
avr_context TaskD_int_context;
#define TaskD_CONTEXT &TaskD_int_context
...
/*
 * Resources used by task TaskD
 *
 * Sem
 */

/*
 * Static descriptor of task TaskD
 */
CONST(tpl_proc_static, OS_CONST) TaskD_task_stat_desc = {
  /* context                  */  TaskD_CONTEXT,
  /* stack                    */  TaskD_STACK,
  /* entry point (function)   */  TaskD_function,
  /* internal ressource       */  NULL,
  /* task id                  */  TaskD_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task TaskD
 */
VAR(tpl_proc, OS_VAR) TaskD_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
 ...
 */
/*-----------------------------------------------------------------------------
 * Alarm a1000ms descriptor
 *
 * This alarm does the activation of task TaskD
 */
...
CONST(tpl_task_activation_action, OS_CONST) a1000ms_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) a1000ms_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , a1000ms_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&a1000ms_action
};
...
VAR(tpl_time_obj, OS_VAR) a1000ms_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&a1000ms_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  976,
    /* date                         */  976,
...
CONST(tpl_task_activation_action, OS_CONST) a20ms_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskS_id
...
CONST(tpl_alarm_static, OS_CONST) a20ms_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , a20ms_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&a20ms_action
};
...
VAR(tpl_time_obj, OS_VAR) a20ms_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&a20ms_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  20,
    /* date                         */  20,
